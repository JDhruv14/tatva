      ...
      <main className="relative z-10 max-w-3xl mx-auto px-6 pt-32">
        ...
        <section className="mb-16 animate-fade-up-delay-2">
          <div className="flex flex-col items-center gap-4">
            <div className="relative w-full max-w-lg rounded-lg overflow-hidden shadow-lg"><img src="/gita.png" alt="Bhagavad Gita" className="w-full h-auto object-cover" /></div>
